...
?>
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
        <form action="upload_cert.php" method="post" enctype="multipart/form-data">
            <div class="container-fluid py-4">
                <div class="row">
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            ...
                            <p class="text-dark text-lg font-weight-normal ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control custom-width" type="file" id="jpgFiles" name="jpgFiles[]" multiple="multiple">
                                </div>
                            </p>
