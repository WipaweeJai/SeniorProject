            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">รหัสกิจกรรม</th>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <!-- เปลี่ยนเป็น Checkbox หรืออื่น ๆ ตามความเหมาะสม -->
                          <input type="checkbox" id="checkbox<?php echo $row['activity_id']; ?>" 
                          class="form-check-input me-3" value="<?php echo $row['activity_id']; ?>">
                        </div>
