              ...
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-md-8 mb-md-0 mb-4">
                    <input class="form-control" type="text" name="refInput" id="refInput"
                      placeholder="กรอกหมายเลขใบประกาศ" value="<?= $ref ?>">
                  </div>
            ...
            <div class="col-md-7 mt-4">
              <div class="card">
                <div class="card-header pb-0 px-3 text-success text-lg">
                  ...
                  <span id="refInputValue" class="ms-2">
                    <?= $cert_Ref ?>
                  </span>
                </div>
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                      <div class="d-flex flex-column">
                        <span class="mb-2 text-sm">กิจกรรม : <span id="event_name"
                            class="text-dark font-weight-bold ms-sm-2">
                            <?= $event_name ?>
                          </span></span>
                        <span class="mb-2 text-sm">ชื่อ : <span id="name" class="text-dark font-weight-bold ms-sm-2">
                            <?= $name ?>
                          </span></span>
                        <a class="download-link" href="<?php echo $image_url; ?>" download>
                          <button type="button"
                            class="btn bg-gradient-info btn-sm font-weight-normal">ดาวน์โหลดใบประกาศ</button>
                        </a>
                      </div>
                    </li>
                  </ul>
