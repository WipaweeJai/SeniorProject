...
<body class="">
  <div class="container position-sticky z-index-sticky top-0">
    <div class="row">
      <div class="col-12">
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg blur-rounded glass top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
  ...
  <main class="main-content  mt-0">
    <section>
      <!-- <div class="page-header min-vh-75" style="background-image:url('../assets/img/2.jpg')"> -->
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/2.jpg')"></div>
              </div>
            </div>
